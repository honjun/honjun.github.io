title: vue.js初入门(五计算属性)
author: hojun
avatar: /images/favicon.png
authorDesc: 一个好奇的人
categories: 技术
date: 2018-05-11 00:10:29
authorLink:
authorAbout:
tags:
 - 前端
...
这也同样意味着下面的计算属性将不再更新，因为 Date.now() 不是响应式依赖(data中的数据是响应式依赖)：
```html
computed: {
  now: function () {
    return Date.now()
